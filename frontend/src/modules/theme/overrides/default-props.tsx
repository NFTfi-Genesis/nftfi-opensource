      ...
      defaultProps: {
        slots: {
          ...
          columnMenuSortAscendingIcon: () => (
            <Iconify width={20} icon='ph:arrow-up-bold' />
          ),
          columnMenuSortDescendingIcon: () => (
            <Iconify width={20} icon='ph:arrow-down-bold' />
          ),
          columnMenuFilterIcon: () => (
            <Iconify width={20} icon='ph:funnel-simple' />
          ),
          columnMenuHideIcon: () => (
            <Iconify width={20} icon='solar:eye-closed-bold' />
          ),
          columnMenuManageColumnsIcon: () => (
            <Iconify width={20} icon='ph:square-split-horizontal' />
          ),
          columnSelectorIcon: () => (
            <Iconify width={20} icon='ph:square-split-horizontal' />
          ),
          ...
          // density
          densityCompactIcon: () => (
            <Iconify width={20} icon='ph:article-bold' />
          ),
          densityStandardIcon: () => <Iconify width={20} icon='ph:article' />,
          densityComfortableIcon: () => (
            <Iconify width={20} icon='ph:article-light' />
          ),
          // export
          exportIcon: () => <Iconify width={20} icon='ph:cloud-arrow-down' />,
          // quick filter
          quickFilterIcon: () => (
            <Iconify
              width={24}
