...
import { NftfiLoanV2FixedCollectionSubscriber } from '../src/subscribers/nftfi/loan-v2-fixed-collection';

jest.mock('@ethersproject/contracts', () => ({
  Contract: class {}
}));

describe(NftfiLoanV2FixedCollectionSubscriber.name, () => {
  let subscriber: NftfiLoanV2FixedCollectionSubscriber;
  ...
  beforeEach(async () => {
    ...
    subscriber = moduleRef.get(NftfiLoanV2FixedCollectionSubscriber);
    loanService = moduleRef.get(NftfiLoanService);
  });

  describe(NftfiLoanV2FixedCollectionSubscriber.prototype.onLoanStarted.name, () => {
  ...
  describe(NftfiLoanV2FixedCollectionSubscriber.prototype.onLoanRenegotiated.name, () => {
    it('calls renegotiate with payload and metadata', async () => {
      ...
      await subscriber.onLoanRenegotiated('event-2', emittedAt, 500, '0xcontract', {
        loanId: '1',
  ...
  describe(NftfiLoanV2FixedCollectionSubscriber.prototype.onLoanLiquidated.name, () => {
  ...
  describe(NftfiLoanV2FixedCollectionSubscriber.prototype.onLoanRepaid.name, () => {
