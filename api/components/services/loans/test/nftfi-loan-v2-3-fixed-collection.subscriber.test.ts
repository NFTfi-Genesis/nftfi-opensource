...
import { NftfiLoanV23FixedCollectionSubscriber } from '../src/subscribers/nftfi/loan-v2-3-fixed-collection';

jest.mock('@ethersproject/contracts', () => ({
  Contract: class {}
}));

describe(NftfiLoanV23FixedCollectionSubscriber.name, () => {
  let subscriber: NftfiLoanV23FixedCollectionSubscriber;
  ...
  beforeEach(async () => {
    ...
    subscriber = moduleRef.get(NftfiLoanV23FixedCollectionSubscriber);
    loanService = moduleRef.get(NftfiLoanService);
  });

  describe(NftfiLoanV23FixedCollectionSubscriber.prototype.onLoanStarted.name, () => {
  ...
  describe(NftfiLoanV23FixedCollectionSubscriber.prototype.onLoanRenegotiated.name, () => {
  ...
  describe(NftfiLoanV23FixedCollectionSubscriber.prototype.onLoanLiquidated.name, () => {
  ...
  describe(NftfiLoanV23FixedCollectionSubscriber.prototype.onLoanRepaid.name, () => {
