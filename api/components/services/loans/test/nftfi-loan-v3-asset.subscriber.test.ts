...
import { NftfiLoanV3AssetContract, NftfiLoanV3AssetSubscriber } from '../src/subscribers/nftfi/loan-v3-asset';

jest.mock('@ethersproject/contracts', () => ({
  Contract: class {}
}));

describe(NftfiLoanV3AssetSubscriber.name, () => {
  let subscriber: NftfiLoanV3AssetSubscriber;
  ...
  beforeEach(async () => {
    ...
    subscriber = moduleRef.get(NftfiLoanV3AssetSubscriber);
    loanService = moduleRef.get(NftfiLoanService);
  });

  describe(NftfiLoanV3AssetSubscriber.prototype.onLoanStarted.name, () => {
    it('calls createV3 with normalized payload and metadata', async () => {
      ...
      const contract = buildContract() as NftfiLoanV3AssetContract;
  ...
  describe(NftfiLoanV3AssetSubscriber.prototype.onLoanRenegotiated.name, () => {
  ...
  describe(NftfiLoanV3AssetSubscriber.prototype.onLoanLiquidated.name, () => {
  ...
  describe(NftfiLoanV3AssetSubscriber.prototype.onLoanRepaid.name, () => {
