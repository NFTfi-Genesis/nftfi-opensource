...
import { NftfiLoanV21FixedSubscriber } from '../src/subscribers/nftfi/loan-v2-1-fixed';

jest.mock('@ethersproject/contracts', () => ({
  Contract: class {}
}));

describe(NftfiLoanV21FixedSubscriber.name, () => {
  let subscriber: NftfiLoanV21FixedSubscriber;
  ...
  beforeEach(async () => {
    ...
    subscriber = moduleRef.get(NftfiLoanV21FixedSubscriber);
    loanService = moduleRef.get(NftfiLoanService);
  });

  describe(NftfiLoanV21FixedSubscriber.prototype.onLoanStarted.name, () => {
  ...
  describe(NftfiLoanV21FixedSubscriber.prototype.onLoanRenegotiated.name, () => {
  ...
  describe(NftfiLoanV21FixedSubscriber.prototype.onLoanLiquidated.name, () => {
  ...
  describe(NftfiLoanV21FixedSubscriber.prototype.onLoanRepaid.name, () => {
