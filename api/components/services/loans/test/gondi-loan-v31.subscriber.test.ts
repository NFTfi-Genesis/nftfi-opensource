...
import { GondiLoanService, GondiLoanV31Subscriber, GondiLoanV31Contract } from '../src/subscribers/gondi';

jest.mock('@ethersproject/contracts', () => ({
  Contract: class {}
}));

describe(GondiLoanV31Subscriber.name, () => {
  let subscriber: GondiLoanV31Subscriber;
  ...
  beforeEach(async () => {
    ...
    subscriber = moduleRef.get(GondiLoanV31Subscriber);
    loanService = moduleRef.get(GondiLoanService);
  });

  describe(GondiLoanV31Subscriber.prototype.onLoanStarted.name, () => {
    it('calls service create method', async () => {
      const fnCreate = jest.spyOn(loanService, 'create').mockResolvedValueOnce();
      const contract = buildContract() as GondiLoanV31Contract;
  ...
  describe(GondiLoanV31Subscriber.prototype.onLoanRefinanced.name, () => {
  ...
  describe(GondiLoanV31Subscriber.prototype.onLoanRefinancedNewOffer.name, () => {
    it('calls service refinance method', async () => {
      const fnRefinance = jest.spyOn(loanService, 'refinance').mockResolvedValueOnce();
      const contract = buildContract() as GondiLoanV31Contract;
  ...
  describe(GondiLoanV31Subscriber.prototype.onLoanRepaid.name, () => {
  ...
  describe(GondiLoanV31Subscriber.prototype.onLoanLiquidated.name, () => {
  ...
  describe(GondiLoanV31Subscriber.prototype.onLoanForeclosed.name, () => {
