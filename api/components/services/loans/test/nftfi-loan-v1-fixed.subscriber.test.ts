...
import { NftfiLoanV1FixedSubscriber } from '../src/subscribers/nftfi/loan-v1-fixed';

jest.mock('@ethersproject/contracts', () => ({
  Contract: class {}
}));

describe(NftfiLoanV1FixedSubscriber.name, () => {
  let subscriber: NftfiLoanV1FixedSubscriber;
  ...
  beforeEach(async () => {
    ...
    subscriber = moduleRef.get(NftfiLoanV1FixedSubscriber);
    loanService = moduleRef.get(NftfiLoanService);
  });

  describe(NftfiLoanV1FixedSubscriber.prototype.onLoanStarted.name, () => {
  ...
  describe(NftfiLoanV1FixedSubscriber.prototype.onLoanLiquidated.name, () => {
  ...
  describe(NftfiLoanV1FixedSubscriber.prototype.onLoanRepaid.name, () => {
