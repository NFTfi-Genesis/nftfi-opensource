...
import { NftfiLoanV3CollectionContract } from './nftfi-loan-v3-collection.contract';
import type {
...
@Subscriber(NftfiLoanV3CollectionContract)
export class NftfiLoanV3CollectionSubscriber {
  constructor(private readonly loanService: NftfiLoanService) {}

  @EventHandler(NftfiLoanV3CollectionContract.Event.LoanStarted)
  async onLoanStarted(
  ...
  @EventHandler(NftfiLoanV3CollectionContract.Event.LoanRenegotiated)
  ...
  @EventHandler(NftfiLoanV3CollectionContract.Event.LoanLiquidated)
  ...
  @EventHandler(NftfiLoanV3CollectionContract.Event.LoanRepaid)
  async onLoanRepaid(
