...
import { NftfiLoanV23FixedCollectionContract } from './nftfi-loan-v2-3-fixed-collection.contract';
import type {
...
@Subscriber(NftfiLoanV23FixedCollectionContract)
export class NftfiLoanV23FixedCollectionSubscriber {
  constructor(private readonly loanService: NftfiLoanService) {}

  @EventHandler(NftfiLoanV23FixedCollectionContract.Event.LoanStarted)
  async onLoanStarted(
  ...
  @EventHandler(NftfiLoanV23FixedCollectionContract.Event.LoanRenegotiated)
  ...
  @EventHandler(NftfiLoanV23FixedCollectionContract.Event.LoanLiquidated)
  ...
  @EventHandler(NftfiLoanV23FixedCollectionContract.Event.LoanRepaid)
  async onLoanRepaid(
